...
<div class="flex items-center justify-center min-h-screen bg-[#1E1F25]">
    <div class="relative flex flex-col m-6 space-y-8 bg-[#323741] border-2 border-gray-600 shadow-2xl rounded-2xl md:flex-row md:space-y-0">
        <!-- left side -->
        <div class="flex flex-col justify-center p-8 md:p-14">
            ...
            <form class="space-y-4 md:space-y-6" id="loginForm" action="#">
                <div class="py-4">
                    ...
                    <input type="text" name="un_id" placeholder="Enter your ID" class="bg-[#1E1F25] border border-[#424650] text-[#FFFFFF]  sm:text-sm rounded-lg focus:ring-[#827FFF] focus:border-[#827FFF] block w-full p-2.5 dark:bg-gray-700 dark:border-[#424650] placeholder-[#FFFFFF]  dark:text-white  dark:focus:border-[#7879C5]"  required="">
                ...
                <div class="py-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Enter your password" class="bg-[#1E1F25] border border-[#424650] text-[#FFFFFF]  sm:text-sm rounded-lg focus:ring-[#827FFF] focus:border-[#827FFF] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-[#FFFFFF] dark:text-white dark:focus:border-[#827FFF]">
                    <!-- Error message placeholder -->
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.errors) {
                        ...
                        if (response.errors.un_id) {
                            $('#error-un_id').text(response.errors.un_id[0]);
                            $('input[name="un_id"]').addClass('is-invalid');
                        }
