        ...
        <form action="#" >
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mt-5">
                ...
                <div class="relative mb-4">
                    ...
                    <div class="flex items-center">
                        <input type="text" name="text" id="text" value="{{auth()->user()->department}}" class="bg-[#1E1F25] border border-[#424650] text-white sm:text-sm rounded-lg focus:ring-[#827FFF] focus:border-[#827FFF] block w-full p-2.5  dark:border-[#424650] placeholder-[#FFFFFF]  dark:text-white  dark:focus:border-[#7879C5]"  readonly required="">
