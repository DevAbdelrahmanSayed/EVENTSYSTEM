...
<div class="antialiased bg-[#23242A]">
    ...
    <main class="p-4  md:ml-64 h-auto pt-20">
        ...
        <div class=" flex flex-wrap justify-start items-center px-2 py-3 space-x-2  rounded-lg border border-[#424650] bg-[#323741] mt-4">
            <button type="button"
                    class="px-4 py-2 text-sm font-medium text-[#F5F5F7] bg-[#2a2d35] border border-[#424650] rounded-full hover:bg-[#827FFF] hover:text-[#F5F5F7] focus:z-10 focus:ring-2 focus:ring-[#827FFF] focus:text-[#F5F5F7] mb-1">
                Programming
            </button>
        </div>
        <!---Badges--------------------------------->
