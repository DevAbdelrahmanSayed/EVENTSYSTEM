...
<nav class="bg-[#323741] border-b border-[#424650] px-4 py-2.5 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="ClubPage.html" class="flex items-center justify-between mr-4">
                <img
...
>
    ...
    <div class="py-4 px-4 bg-[#323741] mb-2">
        <div class="flex items-center">
            <img  src="{{asset('assets/image/logo2.png')}}" alt="Profile" class="w-12 h-12 rounded-full" />
            <div class="ml-3">
                <p class="text-lg font-semibold text-gray-900 text-white">Naji Aysar</p>
                <p class="text-white">ID: 123456</p>
            </div>
            <a href="Notification.html" class="relative inline-flex rounded-full  hover:bg-[#827FFF] ml-5">
                <svg class="w-[32px] h-[32px] text-gray-800 text-white round " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
