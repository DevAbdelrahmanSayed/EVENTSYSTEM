                    ...
                    success: function (response) {
                        ...
                        if (response.data && response.data.length > 0) {
                            ...
                            response.data.forEach(function (club) {
                                ...
                                $template.find('.club-link').attr('href', "{{ route('clubs.show', ':id') }}".replace(':id', club.id));
                                $template.find('.club-image').attr('src', club.image || 'default-image-url.jpg').attr('alt', club.name);
                                $template.find('.club-name-link').text(club.name).attr('href', "{{ route('clubs.show', ':id') }}".replace(':id', club.id));
                                ...
                                $template.find('.user-name').attr("href","{{ route('clubs.show', ':id') }}".replace(':id', club.user.id));
