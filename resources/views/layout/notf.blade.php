...
@if($errors->any())
    @foreach ($errors->all() as $error)
                <div id="toast-error" class="z-20 important absolute top-[90px]  flex right-6 w-full max-w-xs p-4 text-gray-500 bg-gray-800 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
@if($message['level'] === 'success')
    <div id="toast-success" class="z-20 important absolute top-[90px] flex right-6 w-full max-w-xs p-4 text-gray-500  rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
@if($message['level'] === 'error')
    <div id="toast-warning" class="z-20 important absolute top-[90px] flex right-6  w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
<script>
    window.onload = function() {
        ...
        var errorToasts = document.querySelectorAll('#toast-warning');
